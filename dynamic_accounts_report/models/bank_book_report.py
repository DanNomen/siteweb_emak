...
class BankBookReport(models.TransientModel):
    """For creating Account Bank Book Report"""
...
class ReportBankBook(models.AbstractModel):
    """Contexte de rendu du PDF Bank Book.
    ...
    """
    _name = 'report.dynamic_accounts_report.bank_book'
    ...
    def _get_report_values(self, docids, data=None):
        ...
        return {
            'doc_ids': docids,
            'doc_model': 'bank.book.report',
            'docs': self.env['bank.book.report'].browse(docids or []),
