...
class ClaimController(Controller):
    ...
    def submit_reclamation(self, **kwargs):
        ...
        if not is_product_checked:
            ...
            return request.render("my_website_customer_portal.claim_reclamation_template", context)
        ...
        return request.render("my_website_customer_portal.reclamation_thankyou")
    ...
    def claim_details(self, claim_id, **kw):
        ...
        vals = {"claim": claim}
        return request.render("my_website_customer_portal.claim_detail_template", vals)
